...
export default function Header({ tab, setTab, upload = true, setData, setMetadata }) {
    return (
        <header className="app-header">
            {!upload && (<> 
                <div className="header-left" onClick={(e) => {setData(null); setMetadata(null); setTab('board')}}>
